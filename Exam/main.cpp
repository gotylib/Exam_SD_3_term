...
*/
/*
 Для решения этой задачи можно использовать две очереди: одну для положительных чисел, другую для отрицательных. Считываем числа из файла и добавляем их в соответствующую очередь. Затем объединяем очереди в одну, сначала добавляя все элементы из очереди положительных чисел, а затем все элементы из очереди отрицательных чисел.
*/
/*
    #include <iostream>
#include <fstream>
